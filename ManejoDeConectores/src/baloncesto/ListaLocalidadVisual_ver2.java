...
public class ListaLocalidadVisual_ver2 implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ListaLocalidadVisual_ver2 window = new ListaLocalidadVisual_ver2();
	 ...
	 */
	public ListaLocalidadVisual_ver2() {
		initialize();
	}
	...
	private void initialize() {
		...
		frmBsquedaDeSocios.setTitle("Búsqueda de Socios por localidad Versión 2 con sentencias preparadas");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == btnBuscar) {
			...
			try { // Las 3 instrucciones siguientes se utilizaban en la versi�n 1.
					// String cadenaSQL = "SELECT * FROM Socio";
					// if (!txtBuscar.getText().isEmpty())
					// cadenaSQL = cadenaSQL + " WHERE localidad = '" +txtBuscar.getText() + "'";

				listado = abd.consultaLocalidadFormulario2(txtBuscar.getText());// Llamo al 2º método, el que incluye
