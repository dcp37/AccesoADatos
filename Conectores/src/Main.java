...
public class Main {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		System.out.println("Resultado l�nea 41 -> " + LoginError("Alberto", "11111"));
		System.out.println("Resultado l�nea 42 -> " + LoginError("Alberto", "12345"));
		System.out.println("Resultado l�nea 43 -> " + LoginError("x", "' OR ''='"));
		System.out.println("Resultado l�nea 44 -> " + LoginError("xxx", "' OR username='admin"));
